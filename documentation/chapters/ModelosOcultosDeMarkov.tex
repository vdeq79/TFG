...
\begin{definition}
Definimos \textbf{la variable de retroceso} $\beta_t(i)$ como la probabilidad de observar la secuencia parcial $(O_{t+1},O_{t+2},\dots,O_{r})$ condicionada a que en el instante $t$, el estado sea $s_i$. Es decir:
...
\begin{itemize}
    ...
    \end{align*} 
    \item Para encontrar la secuencia de estados óptimo:
