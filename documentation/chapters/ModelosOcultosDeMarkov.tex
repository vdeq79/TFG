...
\caption{Algoritmo de avance-retroceso normalizado} \label{ForwardBackwardNormalizado}
...
\begin{breakablealgorithm}
\caption{Algoritmo de Baum-Welch} \label{Baum-Welch}
\begin{algorithmic}[1]
\Require{$\lambda=(A,B,\pi)$}
...
\State Llamar a algoritmo \ref{ForwardBackwardNormalizado} \State
...
\While{$iters < maxIters$ y $logProb>oldLogProb$}
    ...
    \State Llamar a algoritmo \ref{ForwardBackwardNormalizado}
