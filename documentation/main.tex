...
\setminted[python]{linenos,tabsize=2,breaklines, breakanywhere, breaksymbolleft=,framesep=2mm,baselinestretch=1.2}
\AtBeginEnvironment{minted}{\renewcommand{\colorbox}[3][]{#3}}



% Archivos de configuración.
\input{style/macros}  % En macros.tex se almacenan las opciones y comandos para escribir matemáticas.
\input{style/classicthesis-config} % En classicthesis-config.tex se almacenan las opciones propias de la plantilla.
...
\ThisULCornerWallPaper{1}{img/ugrA4.pdf}
\maketitle

\input{imports/declaracion-originalidad.tex}
\input{imports/Agradecimientos.tex}
\input{imports/Resumen.tex}
\input{imports/Summary.tex}
...
\input{imports/Introduccion.tex}
\input{chapters/Preliminares.tex}
\input{chapters/CadenasDeMarkov.tex}
\input{chapters/ModelosOcultosDeMarkov.tex}
\input{chapters/AplicacionesALaBiologia.tex}
\input{imports/Conclusion.tex}
